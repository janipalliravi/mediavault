...
android {
    ...
    buildTypes {
        release {
            // Keep signing consistent so updates install over existing app
            signingConfig = signingConfigs.getByName("debug")
            // Enable R8 shrink/optimize/obfuscate for smaller APKs
...
// No explicit Play Core dependency; not using deferred components
