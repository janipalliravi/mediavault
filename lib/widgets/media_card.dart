...
class _MediaCardState extends State<MediaCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return RepaintBoundary(
      child: widget.isGrid ? _buildGrid(context, heroTag, imageFit, cardBorderSide, currentFitPref) : _buildList(context, heroTag, imageFit, cardBorderSide, currentFitPref),
    );
  }

  Widget _buildGrid(BuildContext context, String heroTag, BoxFit imageFit, BorderSide cardBorderSide, String currentFitPref) {
  ...
  Widget _buildList(BuildContext context, String heroTag, BoxFit imageFit, BorderSide cardBorderSide, String currentFitPref) {
    final double gap = ThemeSpacing.gap12;
    return RepaintBoundary(
      child: Container(
